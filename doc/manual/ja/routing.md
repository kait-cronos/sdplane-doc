...
**関連ページ（独立ドキュメント）：**
- [仮想スイッチ（vswitch）](vswitch.md) - vswitch設定・表示コマンド（16コマンド）
- [ネイバーテーブル（ARP/ND）](neighbor.md) - show neighbor
- [FDB（転送データベース）](fdb.md) - show fdb
- [SRv6](srv6.md) - SRv6 Local SID設定・表示
...
FDBコマンドの詳細は [FDB（転送データベース）](fdb.md) を参照してください。
