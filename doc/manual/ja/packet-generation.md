[トップ](../../../README.md) > [ユーザーガイド](README.md) > 管理・設定ガイド > パケット生成
...
- [`show_pktgen`](#show_pktgen) - PKTGEN情報表示
- [`pktgen_init`](#pktgen_init) - PKTGEN初期化
- [`pktgen_do_start`](#pktgen_do_start) - PKTGEN開始
- [`pktgen_do_stop`](#pktgen_do_stop) - PKTGEN停止
