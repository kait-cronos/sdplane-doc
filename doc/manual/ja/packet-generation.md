[ユーザーガイド](README.md) > 管理・設定ガイド > パケット生成
...
- [`show_pktgen`](#show_pktgen-pktgen情報表示) - PKTGEN情報表示
- [`pktgen_init`](#pktgen_init-pktgen初期化) - PKTGEN初期化
- [`pktgen_do_start`](#pktgen_do_start-pktgen開始) - PKTGEN開始
- [`pktgen_do_stop`](#pktgen_do_stop-pktgen停止) - PKTGEN停止
