[トップ](../../../README.md) > [ユーザーガイド](README.md) > 管理・設定ガイド > キュー設定

# キュー設定

**Language:** [English](../en/queue-configuration.md) | **日本語**

DPDKキューの設定と管理を行うコマンドです。

## コマンド一覧

- [`set_thread_lcore_port_queue`](#set_thread_lcore_port_queue) - スレッドキュー設定
- [`show_thread_qconf`](#show_thread_qconf) - スレッドキュー設定表示
