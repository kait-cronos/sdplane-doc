...
- [仮想スイッチ（vswitch）](manual/ja/vswitch.md) - 仮想スイッチの設定と管理
- [ネイバーテーブル（ARP/ND）](manual/ja/neighbor.md) - ネイバーテーブルの表示
- [FDB（転送データベース）](manual/ja/fdb.md) - FDBの表示
- [RIB・ルーティング](manual/ja/routing.md) - RIBとルーティング機能
- [SRv6](manual/ja/srv6.md) - SRv6 Local SIDの設定と表示
...
**コマンド一覧:**
- [全コマンド一覧（アルファベット順）](manual/ja/command-list.md) - 全120コマンドの索引
