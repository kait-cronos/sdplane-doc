...
インストール、設定、実行までの手順は[始めるには](doc/getting-started.ja.md)を参照してください。

## Tips

設定・運用に関するヒント集は[Tips](doc/tips.ja.md)を参照してください。
...
- [仮想スイッチ（vswitch）](doc/manual/ja/vswitch.md) - 仮想スイッチの設定と管理
- [ネイバーテーブル（ARP/ND）](doc/manual/ja/neighbor.md) - ネイバーテーブルの表示
- [FDB（転送データベース）](doc/manual/ja/fdb.md) - FDBの表示
- [RIB・ルーティング](doc/manual/ja/routing.md) - RIBとルーティング機能
- [SRv6](doc/manual/ja/srv6.md) - SRv6 Local SIDの設定と表示
...
- [rte-flow](doc/manual/ja/rte-flow.md) - ハードウェアフロー分類の設定

**コマンド一覧:**
- [全コマンド一覧（アルファベット順）](doc/manual/ja/command-list.md) - 全120コマンドの索引
